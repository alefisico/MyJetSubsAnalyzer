...
#process.TFileService=cms.Service("TFileService",fileName=cms.string('/cms/gomez/Stops/st_jj/patTuples/stopUDD312_ISR_upto2j_50_tree.root'))
process.TFileService=cms.Service("TFileService",fileName=cms.string('/cms/gomez/Stops/st_jj/patTuples/stopUDD312_100_tree.root'))
#process.TFileService=cms.Service("TFileService",fileName=cms.string('/cms/gomez/Stops/st_jj/patTuples/stopUDD312_50_tree.root'))
