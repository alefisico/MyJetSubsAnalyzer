...
def analysisPlots( Sample, inputDir, outputName, outputDir, listHistos, Algo, groomed):
	...
	inputFile1 = TFile.Open( inputDir+Sample+'_'+Algo+'_'+groomed+'_cutHT900_Plots.root' )
	print 'Drawing Histograms from: ', inputFile1.GetName()

	for histoInfo in listHistos:
	
		outputFileName = dateKey+'_'+histoInfo[0]+'_'+outputName+'_'+Algo+'with'+groomed+'_cutHT900.pdf'  
...
def DrawCmpAllGrom( Sample, inputDir, outputName, outputDir, listHistos, Algo):
	...
	for histoInfo in listHistos:
		...
		outputFileName = dateKey+'_'+histoInfo[0]+'_'+outputName+'_'+Algo+'_cmpAllGroomed.pdf'  
		print 'Processing.......', outputFileName
		outputFile = targetDir + outputFileName
		outputList.append( outputFileName )
		print histoInfo[0]
...
#		[ 'jet3Tau32', '#tau_{3} / #tau_{2} 3rd Leading Jet', 'Events / ' ],
	...
	list2DHistos = [
			[ 'jetPtvsMass', 'Jets p_{T} [GeV]', 'Jets Mass [GeV]' ],
			[ 'jetTau2vsTau1', '#tau_{1}', '#tau_{2}' ],
			[ 'jetTau3vsTau1', '#tau_{1}', '#tau_{3}' ],
			[ 'jetTau3vsTau2', '#tau_{2}', '#tau_{3}' ],
			...
			[ 'jet3PtvsMass', '3rd Leading Jet p_{T} [GeV]', '3rd Leading Jet Mass [GeV]' ],
			[ 'jet3Tau2vsTau1', '#tau_{1} 3rd Leading Jet', '#tau_{2} 3rd Leading Jet' ],
			[ 'jet3Tau3vsTau1', '#tau_{1} 3rd Leading Jet', '#tau_{3} 3rd Leading Jet' ],
			[ 'jet3Tau3vsTau2', '#tau_{2} 3rd Leading Jet', '#tau_{3} 3rd Leading Jet' ],
			]
