		...
		if len( tmpListJetIndexDeltaR0p4 ) == 4:		
			...
			######################### Singly Merged
				...
				if ( listDuplicatesDeltaR0p4[0] != tmpListJetIndexDeltaR0p4[0] ) and ( listDuplicatesDeltaR0p4[0] != tmpListJetIndexDeltaR0p4[1] ): 
					...
					jetPt_SinglyMerged_DeltaR0p4_NOMerged.Fill( listP4Jets[ tmpListJetIndex[0] ][0].Pt() )
					jetPt_SinglyMerged_DeltaR0p4_NOMerged.Fill( listP4Jets[ tmpListJetIndex[1] ][0].Pt() )
					...
					invMass_SinglyMerged_DeltaR0p4_Merged.Fill( tmpStopC )
					jetPt_SinglyMerged_DeltaR0p4_NOMerged.Fill( listP4Jets[ tmpListJetIndex[2] ][0].Pt() )
					jetPt_SinglyMerged_DeltaR0p4_NOMerged.Fill( listP4Jets[ tmpListJetIndex[3] ][0].Pt() )
					jetPt_SinglyMerged_DeltaR0p4_Merged.Fill( listP4Jets[ listDuplicatesDeltaR0p4[0] ][0].Pt() )
