...
#patJetCorrFactorsCA8CHSNOJEC = patJetCorrFactors.clone()
#patJetCorrFactorsCA8CHSNOJEC.src = jetSource
#patJetCorrFactorsCA8CHSNOJEC.levels = []
##patJetCorrFactorsCA8CHSNOJEC.payload = 'CA8PFchs'
##patJetCorrFactorsCA8CHSNOJEC.useRho = True
#patJetsCA8CHSNOJEC = patJets.clone()
#patJetsCA8CHSNOJEC.jetSource = jetSource
#patJetsCA8CHSNOJEC.addJetCharge = False
#patJetsCA8CHSNOJEC.embedCaloTowers = False
#patJetsCA8CHSNOJEC.embedPFCandidates = False
#patJetsCA8CHSNOJEC.addAssociatedTracks = False
#patJetsCA8CHSNOJEC.addBTagInfo = False
#patJetsCA8CHSNOJEC.addDiscriminators = False
#patJetsCA8CHSNOJEC.addJetID = False
#patJetsCA8CHSNOJEC.addGenPartonMatch = False
#patJetsCA8CHSNOJEC.embedGenPartonMatch = False
#patJetsCA8CHSNOJEC.addGenJetMatch = False
#patJetsCA8CHSNOJEC.getJetMCFlavour = False
#patJetsCA8CHSNOJEC.jetCorrFactorsSource = cms.VInputTag(cms.InputTag('patJetCorrFactorsCA8CHSNOJEC'))
