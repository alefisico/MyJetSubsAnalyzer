...
#patJetCorrFactorsAK7CHSNOJEC = patJetCorrFactors.clone()
#patJetCorrFactorsAK7CHSNOJEC.src = jetSource
#patJetCorrFactorsAK7CHSNOJEC.levels = []
##patJetCorrFactorsAK7CHSNOJEC.payload = 'AK7PFchs'
##patJetCorrFactorsAK7CHSNOJEC.useRho = True
#patJetsAK7CHSNOJEC = patJets.clone()
#patJetsAK7CHSNOJEC.jetSource = jetSource
#patJetsAK7CHSNOJEC.addJetCharge = False
#patJetsAK7CHSNOJEC.embedCaloTowers = False
#patJetsAK7CHSNOJEC.embedPFCandidates = False
#patJetsAK7CHSNOJEC.addAssociatedTracks = False
#patJetsAK7CHSNOJEC.addBTagInfo = False
#patJetsAK7CHSNOJEC.addDiscriminators = False
#patJetsAK7CHSNOJEC.addJetID = False
#patJetsAK7CHSNOJEC.addGenPartonMatch = False
#patJetsAK7CHSNOJEC.embedGenPartonMatch = False
#patJetsAK7CHSNOJEC.addGenJetMatch = False
